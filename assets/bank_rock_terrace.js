...
export default function generate(THREE) {
  ...
  root.name = "bank_rock_terrace_b_closed_flooded_bank";
  ...
  const W=7.2, H=3.8, D=4.6, NX=15, NZ=17, SEED=37;
  const island=false;
  const variant="b";
  ...
  root.userData.staticBakeable=true; root.userData.assetRole="bank_rock_terrace"; root.userData.closedGeometry=true; root.userData.materialFamilies=['stone','ground','foliage','timber'];
  return root;
}