...
export default function generate(THREE) {
  ...
  root.name = "arrival_habitat_a_closed_flooded_bank";
  ...
  const W=11.2, H=2.05, D=3.36, NX=17, NZ=13, SEED=47;
  const island=false;
  const variant="a";
  ...
  root.userData.staticBakeable=true; root.userData.assetRole="arrival_habitat"; root.userData.closedGeometry=true; root.userData.materialFamilies=['stone','ground','foliage','timber'];
  return root;
}