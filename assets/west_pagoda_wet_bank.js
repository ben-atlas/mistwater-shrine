...
export default function generate(THREE) {
  ...
  root.name = "west_pagoda_wet_bank_a_closed_flooded_bank";
  ...
  const W=8, H=1.55, D=10.2, NX=17, NZ=13, SEED=73;
  const island=true;
  const variant="a";
  ...
  root.userData.staticBakeable=true; root.userData.assetRole="west_pagoda_wet_bank"; root.userData.closedGeometry=true; root.userData.materialFamilies=['stone','ground','foliage','timber'];
  return root;
}